...
class liga2 extends liga1 {
    private final String asal_kab;
    static ArrayList
    <liga2> liga = new ArrayList<>();
    ...
    public void setAsal_kab(String asal_kab) {
        this.asal_kabsal_kab = asal_kab;
    }

    @Override
    public void liga_menu() {
        Scanner ip = new Scanner(System.in);

        while (true) {
            System.out.println("\033[H\033[2J");
            System.out.println("=====================================");
            System.out.println("|       Pendataan Klub Liga 2       |");
            System.out.println("=====================================");
