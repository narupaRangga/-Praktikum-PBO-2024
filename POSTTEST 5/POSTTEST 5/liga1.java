...
public class liga1 {
    ...
    abstract class liga1 {
        protected final String nama_klub;
        protected final String asal_kota;
        protected final String pelatih;
    
        static Scanner ip = new Scanner(System.in);
        static ArrayList
        <liga1> liga = new ArrayList<>();
        ...
        public abstract void liga_menu();
